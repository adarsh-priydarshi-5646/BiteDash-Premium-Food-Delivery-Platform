    ...
    <main className="min-h-screen flex flex-col font-sans text-[#1c1c1c] bg-white selection:bg-red-50">
      ...
      <nav className="absolute top-0 w-full z-50 flex justify-between items-center px-4 md:px-12 py-5 text-white max-w-[1100px] mx-auto left-0 right-0 font-[400]">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 md:w-14 md:h-14 bg-white rounded-full flex items-center justify-center p-2 shadow-md">
        ...
        <div className="flex items-center gap-6 md:gap-10 text-[17px]">
          ...
          <button
            ...
            className="px-4 py-2 bg-white text-[#1c1c1c] rounded-md hover:bg-opacity-90 transition-all font-semibold"
          >
            Sign up
          </button>
        </div>
      ...
      <div className="relative h-[500px] md:h-[600px] w-full flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0 w-full h-full">
          ...
          >
            <source
              src="https://b.zmtcdn.com/web_assets/b40b97e677bc7b2ca77c58c61db266fe1603954218.mp4"
              type="video/mp4"
            />
          </video>
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-4 w-full max-w-[900px]">
          ...
          >
            ...
            <span className="font-bold border-b-2 border-red-500 pb-1">
              {currentCity || 'India'}
            </span>
          </motion.p>
          ...
          >
            ...
            >
              ...
              />
              <FaCaretDown
                className={`text-[#4f4f4f] transition-transform duration-300 ${showCityDropdown ? 'rotate-180' : ''}`}
              />
      ...
      {/* Closing Feature Cards Container */}
      ...
      <div className="max-w-[1100px] mx-auto w-full px-4 py-16">
        <div className="flex flex-col md:flex-row items-end justify-between mb-10 gap-4">
          <div className="flex-1">
            ...
            <h2 className="text-[32px] md:text-[40px] font-[800] text-[#1c1c1c] leading-tight mb-3">
              Trending This Week
            </h2>
              ...
              {[
                {
                  ...
                  items: [
                    ...
                    {
                      img: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=150',
                      speed: 20,
                      scale: 0.7,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?q=80&w=150',
                      speed: 20,
                      scale: 0.7,
                    },
                  ],
                },
                {
                  ...
                  items: [
                    {
                      img: 'https://images.unsplash.com/photo-1482049016688-2d3e1b311543?q=80&w=150',
                      speed: 30,
                      scale: 0.8,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?q=80&w=150',
                      speed: 30,
                      scale: 0.8,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?q=80&w=150',
                      speed: 30,
                      scale: 0.8,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1512152272829-e3139592d56f?q=80&w=150',
                      speed: 30,
                      scale: 0.8,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1585238342024-78d387f4a707?q=80&w=150',
                      speed: 30,
                      scale: 0.8,
                    },
                  ],
                },
                {
                  ...
                  items: [
                    {
                      img: 'https://images.unsplash.com/photo-1571091718767-18b5b1457add?q=80&w=150',
                      speed: 40,
                      scale: 0.9,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1628840042765-356cda07504e?q=80&w=150',
                      speed: 40,
                      scale: 0.9,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1551024709-8f23befc6f87?q=80&w=150',
                      speed: 40,
                      scale: 0.9,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?q=80&w=150',
                      speed: 40,
                      scale: 0.9,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1550547660-d9450f859349?q=80&w=150',
                      speed: 40,
                      scale: 0.9,
                    },
                    {
                      img: 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?q=80&w=150',
                      speed: 40,
                      scale: 0.9,
                    },
                  ],
          ...
          {[
            {
              ...
              content:
                'Bakery, Beverages, Biryani, Burger, Chinese, Desserts, Ice Cream, Italian, Mithai, Momos, Mugali, North Indian, Pizza, Rolls, Sandwich, Shake, South Indian, Street Food.',
              icon: <FaUtensils />,
            },
            {
              id: 2,
              ...
              content:
                'Bakeries, Bars, Beverage Shops, Cafes, Casual Dining, Dessert Parlors, Dhabas, Fine Dining, Food Courts, Kiosks, Lounges, Meat Shops, Microbreweries, Quick Bites, Sweet Shops.',
              icon: <FaStore />,
            },
            {
              id: 3,
              ...
              content:
                "Bikanervala, Burger King, Burger Singh, Dominos, KFC, Krispy Kreme, McDonald's, Pizza Hut, Subway, Starbucks, WOW! Momo.",
              icon: <FaLink />,
            },
            {
              id: 4,
              ...
              content:
                'Delhi NCR, Mumbai, Pune, Bengaluru, Hyderabad, Chennai, Kolkata, Ahmedabad, Chandigarh, Jaipur, Kochi, Coimbatore, Lucknow, Nagpur, Vadodara, Indore, Guwahati.',
              icon: <FaCity />,
            },
          ].map((item) => (
            <div
              ...
              <div key={idx}>
                ...
                <ul className="flex flex-col gap-2">
                  {section.links.map((link) => (
                    <li
                      key={link}
                      className="text-[#4f4f4f] text-[14px] font-[300] hover:text-[#1c1c1c] cursor-pointer transition-colors"
                    >
                      {link}
                    </li>
                  ))}
