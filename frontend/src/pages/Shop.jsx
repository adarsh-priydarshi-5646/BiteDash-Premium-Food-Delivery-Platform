        ...
        <div className="relative w-full h-72 md:h-80 lg:h-96">
          ...
          <div className="absolute inset-0 flex flex-col justify-end px-6 pb-8 md:px-12 md:pb-12">
            <div className="max-w-7xl mx-auto w-full">
              ...
              {}
              {shop.cuisine && <p className="text-gray-200 mt-3 text-lg">{shop.cuisine}</p>}
            </div>
          </div>
        </div>
      )}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        {items.length > 0 ? (
          ...
          <div className="bg-white rounded-2xl p-12 text-center shadow-sm border border-gray-200">
            ...
            <h3 className="text-gray-900 text-xl font-bold mb-2">No Items Available</h3>
            <p className="text-gray-500 mb-6">This restaurant hasn't added any items yet</p>
            <button
              onClick={() => navigate('/')}
