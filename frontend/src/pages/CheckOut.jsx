                    ...
                    userData?.addresses?.map((addr) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-3">
                          <span
                            className={`px-2 py-0.5 rounded-lg text-[10px] font-extrabold uppercase tracking-widest ${
                              selectedAddressId === addr._id
                ...
                <div className="mt-8 pt-8 border-t border-gray-100">
                  <div className="mb-4 space-y-3">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block">
                      Search or detect delivery location
                    </label>
                  ...
                  <div className="h-64 w-full rounded-2xl overflow-hidden border border-gray-200 shadow-inner relative">
                    {(location.lat || selectedAddress?.lat) && (
                      <MapContainer
                        ...
                        center={[
                          location.lat || selectedAddress?.lat || 0,
                          location.lon || selectedAddress?.lon || 0,
                        ]}
                        zoom={16}
                      ...
                      >
                        ...
                        <RecenterMap
                          location={{
                            lat: location.lat || selectedAddress?.lat,
                            lon: location.lon || selectedAddress?.lon,
                          }}
                        />
                        <Marker
                          position={[
